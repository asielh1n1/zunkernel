...
exports.ExecCommand=function(values){
    switch (values[0]) {
        ...
        case 'bundle:restapi':{//Genera una api rest para el modelo especificado
            ...
            var routingTemplate=zun.renderFile(zun.basedir+'/node_modules/zunkernel/lib/template_routing.json',{model:values[2]})
            if(!fs.writeFileSync(routingDir + "/"+values[2]+".json", routingTemplate)){
                ...
                var controllerTemplate=zun.renderFile(zun.basedir+'/node_modules/zunkernel/lib/template_controller.js',{bundle:values[1],model:values[2],driver:driver})
